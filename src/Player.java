...
// player image and place on the stage and other verable definations 
    ...
    private void setupAnimations() {
        ...
        Animation amaterasuDragonRightAnimation = new Animation(createAnimationFrames("Amaterasu Dragon_R", "png", 17, 0, 0), this);
        amaterasuDragonRightAnimation.stopAtEnd();
        setAnimationFor("amaterasuDragonRight", amaterasuDragonRightAnimation);

        Animation amaterasuDragonLeftAnimation = new Animation(createAnimationFrames("Amaterasu Dragon_L", "png", 17, 0, 0), this);
        amaterasuDragonLeftAnimation.stopAtEnd();
        setAnimationFor("amaterasuDragonLeft", amaterasuDragonLeftAnimation);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_J:
                currentAction = "amaterasuDragonRight";
                goingRight = true;
                break;
            ...
            case KeyEvent.VK_K:
                ...
                if (isAttackHittingRock() == true && getAnimationFor(currentAction).getCurrentFrameIndex() == 18) {
                    nRock1HitCounter = nRock1HitCounter + 1;
                }
                goingRight = true;
                break;
            case KeyEvent.VK_L:
    ...
    public boolean isAttackHittingRock() {
        ...
        if ("rasenganRight".equals(currentAction)) {
            ...
            if ("amaterasuDragonRight".equals(currentAction)) {
                nFrontOfAttack = (getX());//anim.getCurrentFrameIndex()));
                if (nFrontOfAttack > (rock1X - 70) && nFrontOfAttack < (rock1X + 42)) {
                    return true;
                }
